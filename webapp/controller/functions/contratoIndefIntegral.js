            ...
            for (let i = 0; i < aUsers.length; i++) {
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    <table style="width:100%;border-collapse:collapse;font-size:9.5pt;margin:14px 0 16px 0;">
                        ...
                        <tr><td style="border:1px solid #000;padding:1px 5px;font-weight:bold;background-color:#DCEEFF;">PERÍODO DE PAGO</td><td style="border:1px solid #000;padding:1px 5px;"></td></tr>
