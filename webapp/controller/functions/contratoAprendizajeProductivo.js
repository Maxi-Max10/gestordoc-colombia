sap.ui.define([
    ...
    async function onDownloadPDFContratoAprendizajeProductivo(oController, sButtonId) {
        try {
            ...
            for (let i = 0; i < aUsers.length; i++) {
                ...
                // ══════════════════════════════════════════════════════════════
                const STYLE = `font-family:Arial,sans-serif;font-size:9.3pt;line-height:1.2;padding:25px 24px 20px 24px;color:#000;`;
                const HEADER = `
                    <div style="
                        width:100%;
                        text-align:center;
