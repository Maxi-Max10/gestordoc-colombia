sap.ui.define([
    ...
    async function onDownloadPDFContratoTerminoIndef(oController, sButtonId, mOptions) {
        ...
        try {
            ...
            for (let i = 0; i < aUsers.length; i++) {
                ...
                if (sButtonId.includes("wordDataInfo")) {
                    ...
                    await wordGenerator.generateWord({
                        ...
                        data: {
                            ...
                            sCargo, sSalario, sSalarioLetras, sfechaContratacion, sPeriodoPago, slocalDateMayus, sFechaIniciacionMayus
                        }
                    });
                    continue;
                }
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_bloqueContrato(`
                        Poner al servicio de <strong>EL EMPLEADOR</strong> toda su capacidad normal de trabajo, en forma exclusiva, en
                        el desempeño de las funciones o labores propias, anexas o complementarias a los trabajos de una
                    ...
                    ${_itemContrato("a.", `
                        ...
                        empleo, cargo u oficio a donde lo promueva <strong>EL EMPLEADOR</strong> bajo su dependencia, y que
                        sea capaz de desempeñar, especialmente cuando estos traslados se originen por la
                        modernización de equipos, adopción de nuevas tecnologías y procesos o la implantación
               ...
               // ── PÁGINA 2 ──────────────────────────────────────────────────
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_itemContrato("b.", `
                        A trabajar la jornada máxima legal establecida y de acuerdo con el horario y turno que <strong>EL
                        EMPLEADOR</strong> le señale.
                    `)}

                    ${_itemContrato("c.", `
                        De conformidad con lo dispuesto en el literal d) del artículo 161 de C.S.T norma que fue
                        adicionada por el artículo 51 de la ley 789 de 2002, <strong>EL TRABAJADOR</strong> cumplirá su jornada
                        de trabajo en los turnos y horarios que determine <strong>EL EMPLEADOR</strong> dentro de un esquema
                        de jornada de trabajo flexible. Por acuerdo expreso entre las partes la jornada diaria de
                        trabajo podrá repartirse en la forma que resulte más adecuada conforme lo determine <strong>EL
                        EMPLEADOR</strong>, teniendo en cuenta que los tiempos de descanso dentro de las secciones
                        determinadas no se computan dentro de la jornada y que el presente contrato de trabajo
                        se desarrollará dentro en el marco de una jornada de trabajo flexible.
                    `)}


                    ${_itemContrato("d.", `
                        A guardar en el desempeño de sus funciones y fuera de ellas, discreción, sigilo, lealtad,
                        confidencia y estricta reserva de todo lo que llegue a su conocimiento en razón de su
                        oficio, especialmente los secretos profesionales, industriales o comerciales de la Empresa,
                        o que sean de naturaleza reservada, o aquellos asuntos cuya comunicación puedan causar
                        perjuicio a <strong>EL EMPLEADOR</strong>
                    `)}

                    ${_itemContrato("e.", `
                        Responder por todos y cada uno de los elementos de trabajo que le entregue <strong>EL
                        EMPLEADOR</strong> para el desempeño de su cargo
                    `)}

                    ${_itemContrato("f.", `
                        Devolver oportunamente los equipos, valores, documentos, carpetas y demás elementos
                        de trabajo que le entregue <strong>EL EMPLEADOR</strong> para el desempeño de su cargo
                    `)}

                    ${_itemContrato("g.", `
                        Entregar oportunamente de conformidad con las instrucciones y los procedimientos
                    ...
                    ${_itemContrato("h.", `
                        Consagrar toda su actividad en el desempeño de sus funciones, absteniéndose de ejecutar
                        labores u ocupaciones que puedan entorpecer dicho desempeño o menoscabar su
                        rendimiento personal, así como todas aquellas que emanen de la naturaleza de la labor
                        contratada;
                    `)}

                    ${_itemContrato("i.", `
                        Conservar y restituir en buen estado, salvo el deterioro natural, los instrumentos,
                        máquinas, útiles y demás elementos que se le hayan facilitado.
                    `)}
                    ...
                    ${_itemContrato("k.", `
                        Comunicar oportunamente a EL EMPLEADOR las observaciones que estime conducentes a
                    ...
                    ${_itemContrato("o.", `
                        Registrar en las oficinas del EMPLEADOR, su dirección, número de teléfono y domicilio y
                        dar aviso inmediato de cualquier cambio que ocurra;
                    `)}
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_tituloContrato(
                        ...
                        expresamente que no constituyen salario los pagos o reconocimientos que se le hagan al
                        primero por concepto de beneficios o auxilios habituales u ocasionales acordados convencional o
                        contractualmente u otorgados en forma extralegal por <strong>EL EMPLEADOR</strong>, tales como la
                        alimentación, habitación o vestuario, las primas o bonificaciones extralegales de vacaciones, de
                        servicios, auxilios o becas para estudios, auxilios por muerte de familiares o por calamidad
                        doméstica, auxilios o reconocimientos por medicamentos o consultas médicas u odontológicas, o
                        cualquier otro beneficio similar a los anteriormente enunciados, de acuerdo con lo consagrado en
                        el artículo 15 de la ley 50 de 1990.
                        `
                    )}

                    ${_bloqueContrato(`
                        Las partes acuerdan que la realización del pago del auxilio que pueda recibir <strong>EL TRABAJADOR</strong>
                        como resultado de su participación en el Programa Metas, Programa Ideas o en el Programa GSP,
                        no constituyen salario para ningún afecto legal de conformidad con el artículo 128 del CST,
                        subrogado por el artículo 15 de la ley 50 de 1990, debido a que se debe a mera liberalidad de la
                        compañía
                    `)}
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_tituloContrato(
                        ...
                        "DURACIÓN:",
                        `
                        El presente contrato de trabajo se ha pactado a término indefinido; no obstante,
                        tendrá vigencia mientras subsistan las causas que le dieron origen, de acuerdo con las
                        disposiciones legales sobre el particular. De igual forma terminará por las causas contempladas
                        en la ley.
                        `
                    )}
                    ...
                    ${_tituloContrato(
                        ...
                        "PARÁGRAFO:",
                        `
                        En cumplimiento del deber general de las partes de ejecutar el contrato de trabajo
                        de buena fe, EL TRABAJADOR entiende que en caso de dar por terminado de manera unilateral el
                        contrato de trabajo actualmente vigente, debe dar previo aviso a EL EMPLEADOR sobre dicha
                        decisión, con una antelación no inferior a treinta (30) días calendario a la fecha de terminación
                        del contrato.
                        `
                    )}
                    ...
                    ${_tituloContrato(
                        ...
                        en que se comienzan las labores, se consideran como PERÍODO DE PRUEBA en el que <strong>EL
                        EMPLEADOR</strong> podrá apreciar las aptitudes de <strong>EL TRABAJADOR</strong> y éste la conveniencia de las
                        condiciones de trabajo. Por lo tanto, durante este período, el contrato puede darse por
                        terminado unilateralmente en cualquier momento, sin previo aviso y sin indemnización alguna.
                        `
                    )}
                    ...
                    ${_bloqueContrato(`
                        ...
                        funciones directamente para <strong>EL EMPLEADOR</strong> o para cualquier otra empresa o sociedad que aquel
                        designe de acuerdo con los convenios de colaboración (o de cualquier otra naturaleza) que <strong>EL
                        EMPLEADOR</strong> haya celebrado para tal fin. De esa manera, para las partes es claro que las
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;position:relative;">
                    ...
                    ${_itemContrato("xxii.", `
                        Retener, sustraer o apropiarse de documentos o elementos de trabajo de propiedad de EL
                        EMPLEADOR; (j) Presentar cuentas, recibos de gastos, facturas, informes o cualquier otro
                        documento ficticio, modificado, adulterado o reportar como cumplidas actividades o tareas
                        no efectuadas; (k) Negarse a la aplicación de cualquier tipo de pruebas de alcoholemia,
                        que de manera aleatoria practique la empresa, a efectos de llevar un control preventivo de
                        riesgos y accidentes en el lugar de trabajo.
                    `)}
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_bloqueContrato(`
                        medidas disciplinarias establecidas en el reglamento interno de trabajo
                        y en la normatividad laboral aplicable, en forma inmediata al conocimiento que tenga
                        <strong>EL EMPLEADOR</strong> de la violación.
                    `)}
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_bloqueContrato(`
                        por escrito por un superior jerárquico, salvo cuando la necesidad de tal trabajo se presente de manera
                        imprevista, caso en el cual, deberá ejecutarse y darse aviso inmediato al respectivo superior jerárquico.
                    `)}
                    ...
                    ${_tituloContrato(
                        ...
                        contrato por cualquier causa. Asimismo, se abstendrá de revelar
                        `
                    )}
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_bloqueContrato(`
                        o divulgar información a terceros, o utilizarla para fines propios diferentes de los que
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_continuacionItemContrato( `
                        información confidencial deberá ser proporcionada exclusivamente a aquellas
                        personas que, en virtud de dicha obligación legal, reglamentaria o judicial, deban recibirla.
                    `)}
                    ...
                    ${_tituloContrato(
                        ...
                        "DESCUENTOS:",
                        `
                        <strong>EL TRABAJADOR</strong> autoriza desde ahora a <strong>EL EMPLEADOR</strong> para que, de sus
                        salarios, prestaciones sociales e indemnizaciones, le descuente, durante vigencia del contrato o al
                        momento de la terminación del mismo, por cualquier causa, las sumas de dinero que por
                        cualquier motivo le llegare a adeudar.
                        `
                    )}
                    ...
                    ${_tituloContrato(
                        ...
                        "INFORMACIÓN:",
                        `
                        Es obligación de <strong>EL TRABAJADOR</strong> Informar por escrito y de inmediato al
                        <strong>EL EMPLEADOR</strong> cualquier cambio en su dirección de residencia y teléfono además de cualquier
                        información que sea requerida por <strong>EL EMPLEADOR</strong>.
                        `
                    )}
                    ...
                    ${_tituloContrato(
                        ...
                        incorporados los preceptos legales y las disposiciones de <strong>EL EMPLEADOR</strong> que regulen las
                        relaciones de trabajo. Adicionalmente, <strong>EL TRABAJADOR</strong> se obliga a cumplir el reglamento
                        interno de trabajo y el reglamento de Higiene y Seguridad Industrial, los cuales declara conocer.
                        De igual forma es obligación de <strong>EL TRABAJADOR</strong> conocer y acatar los Reglamentos Internos de
                        Trabajo y de Higiene y Seguridad Industrial que en el futuro se aprueben
                        `
                    )}
                    ...
                    ${_tituloContrato(
                        ...
                        jurisprudencia y será interpretado de buena fé y en consonancia con el Código Sustantivo del
                        Trabajado cuyo objeto definitivo es su artículo 1ro. es lograr la justicia en las relaciones entre
                        <strong>EMPLEADORES</strong> y <strong>TRABAJADORES</strong>, dentro de un espíritu de coordinación económica y equilibrio
                        social
                        `
                    )}
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_tituloContrato(
                        ...
                        presente contrato y en cumplimiento de las obligaciones que fueron pactadas en el presente contrato.
                    ...
                    ${_bloqueContrato(`
                        20. El presente contrato reemplaza en su integridad y deja sin efecto alguno, cualquier otro
                    ...
                    ${_tituloContrato(
                        ...
                        `
                        <strong>EL TRABAJADOR</strong> declara que conoce y
                        acepta la Política de Seguridad de la Información de <strong>EL EMPLEADOR</strong> y acepta que en caso de
                        incumplimiento el presente contrato se terminará con justa causa y se le impondrá a título
                        apremio una suma de dinero correspondiente a veinticuatro (24) veces el valor estipulado en la
                        cláusula segunda del presente contrato, sin perjuicio de las indemnizaciones de perjuicios a que
