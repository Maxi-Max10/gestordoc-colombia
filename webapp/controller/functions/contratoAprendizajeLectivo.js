sap.ui.define([
    ...
    async function onDownloadPDFContratoAprendizajeLectivo(oController, sButtonId, mOptions) {
            ...
            for (let i = 0; i < aUsers.length; i++) {
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_bloqueContrato(`
                        ...
                        <strong>${sCedula}</strong> Expedida en XXXXXXXXXXXXXX, quien para los efectos del presente contrato se
                    ...
                    ${_tituloContrato(
                        ...
                        subordinación se limita a las actividades propias del aprendizaje de acuerdo con el literal b) del
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_subItemContrato("1.", `
                        Si es una formación dual, el aprendiz recibirá como mínimo durante el primer año el
                        equivalente al 75% de un salario mínimo mensual legal vigente, y durante el segundo año el
                        equivalente al 100% de un salario mínimo mensual legal vigente.
                    `)}

                    ${_subItemContrato("2.", `
                                Si es formación tradicional, el aprendiz recibirá como mínimo en la fase lectiva el equivalente al
                        75% de un salario mínimo mensual legal vigente, y en la etapa práctica, el equivalente al 100%
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_itemContrato("d)", `
                        Durante la etapa lectiva y práctica, se realizarán los aportes a seguridad social y los subsistemas
                        que apliquen de acuerdo con las normas que regulen la materia y en los términos que dichas normas
                        lo indiquen.
                    `)}
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_paragrafoContrato(
                        ...
                        Información de la <strong>EMPRESA</strong>, y en consecuencia se obliga a: 3.1. Utilizar los Sistemas de Información
                        únicamente para propósitos aprobados con ocasión del desarrollo del Contrato de Aprendizaje. 3.2.
                        ...
                        cumplimiento de la etapa práctica del contrato de aprendizaje. 3.3. Notificar inmediatamente al líder
                        ...
                        ilegal. 3.4. Dar adecuado manejo a los recursos tecnológicos y solicitar los requerimientos de
                ...
                <div style="${STYLE}width:100%;box-sizing:border-box;">
                    ...
                    ${_continuacionItemContrato(`Transmitir o transferir los datos a aliados, matriz, filiales o subordinadas.`)}
    ...
    async function _generateWord(data) {
        ...
        const templateBytes = await fetch("pdf/Contrato_Aprendizaje_Lectivo.docx").then(res => {
            if (!res.ok) throw new Error(`No se pudo cargar Contrato_Aprendizaje_Lectivo.docx (${res.status})`);
        ...
        const link = document.createElement("a");
        link.href  = URL.createObjectURL(blob);
        link.download = `${data.firstName}_${data.lastName}_Contrato_Aprendizaje_Lectivo.docx`;
    ...
    return {
        onDownloadPDFContratoAprendizajeLectivo,
        generatePdfDocuments: function (oController) {
            return onDownloadPDFContratoAprendizajeLectivo(oController, "pdfDataInfo", {
